...
import { Search, ShoppingCart, User, Menu, X, Sparkles, Box } from 'lucide-react'
          ...
          {user ? (
            <div className="flex items-center gap-2">
              <Button
                variant="outline"
                size="sm"
                className="hidden md:flex bg-background border-border/50 text-xs"
                onClick={() => navigate('/admin')}
              >
                <Box className="w-3 h-3 mr-2" /> Admin
              </Button>
