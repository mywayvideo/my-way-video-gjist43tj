...
//       search_words text[];
//   BEGIN
//       -- Transforma a busca em um array de palavras, removendo vírgulas e espaços
...
//                   FROM products
//                   WHERE (
//                       -- Busca por similaridade de qualquer uma das palavras
//                       EXISTS (
//                           SELECT 1 FROM unnest(search_words) as word 
//                           WHERE length(word) > 2 
//                           AND (name ILIKE '%' || word || '%' OR sku ILIKE '%' || word || '%')
//                       )
//                       -- Ou se o termo completo bater em algum lugar
