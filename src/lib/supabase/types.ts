...
//       search_words text[];
//   BEGIN
//       -- Limpa o termo e quebra em palavras
...
//                   AND (
//                       -- Match por palavras individuais (Se achar 'Burano', já conta)
//                       EXISTS (
...
//                   )
//                   ORDER BY
//                       -- Prioriza quem tem mais palavras batendo
//                       (SELECT count(*) FROM unnest(search_words) as w
//                        WHERE name ILIKE '%' || w || '%' OR sku ILIKE '%' || w || '%') DESC,
//                       price_usd DESC
//                   LIMIT 20
//               ) p
//           ),
