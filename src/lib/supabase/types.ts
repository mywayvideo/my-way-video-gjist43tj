...
//     USING: (current_setting('request.jwt.claim.role'::text, true) = 'administrator'::text)
//     WITH CHECK: (current_setting('request.jwt.claim.role'::text, true) = 'administrator'::text)
//   Policy "avpro_keywords_no_access_authenticated" (SELECT, PERMISSIVE) roles={authenticated}
//     USING: false
