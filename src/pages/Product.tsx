...
import { ShoppingCart, Check, ShieldAlert, Bot, MapPin } from 'lucide-react'
...
export default function Product() {
  ...
  const handleAskAI = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    toast({
      title: 'IA Analisando...',
      description: `Buscando resposta técnica no DB em tempo real.`,
    })
    input.value = ''
  }

  if (!product) return <div className="p-12 text-center">Carregando produto...</div>
