import { n as __commonJSMin } from "./index-CTUw1U-A.js";
//#region ../../cache/modules/my-way-video-ia-ede01/node_modules/.pnpm/html2canvas@1.4.1/node_modules/html2canvas/dist/html2canvas.js
		...
		*/
		...
		var Tokenizer = function() {
			...
			Tokenizer.prototype.consumeToken = function() {
				...
				switch (codePoint) {
					case QUOTATION_MARK: return this.consumeStringToken(QUOTATION_MARK);
					case NUMBER_SIGN:
					...
					case DOLLAR_SIGN:
						...
						break;
					case APOSTROPHE: return this.consumeStringToken(APOSTROPHE);
					case LEFT_PARENTHESIS: return LEFT_PARENTHESIS_TOKEN;
					case RIGHT_PARENTHESIS: return RIGHT_PARENTHESIS_TOKEN;
					case ASTERISK:
						if (this.peekCodePoint(0) === EQUALS_SIGN) {
							this.consumeCodePoint();
					...
					case SOLIDUS:
						...
						break;
					case COLON: return COLON_TOKEN;
					case SEMICOLON: return SEMICOLON_TOKEN;
					case LESS_THAN_SIGN:
						...
						break;
					case COMMERCIAL_AT:
						if (isIdentifierStart(this.peekCodePoint(0), this.peekCodePoint(1), this.peekCodePoint(2))) {
							var value = this.consumeName();
							return {
								type: 7,
								value
						...
						break;
					case LEFT_SQUARE_BRACKET: return LEFT_SQUARE_BRACKET_TOKEN;
					case REVERSE_SOLIDUS:
						...
						break;
					case RIGHT_SQUARE_BRACKET: return RIGHT_SQUARE_BRACKET_TOKEN;
					case CIRCUMFLEX_ACCENT:
						...
						break;
					case LEFT_CURLY_BRACKET: return LEFT_CURLY_BRACKET_TOKEN;
					case RIGHT_CURLY_BRACKET: return RIGHT_CURLY_BRACKET_TOKEN;
					case u:
					case U:
		...
		var parseNamedSide = function(tokens) {
			switch (tokens.filter(isIdentToken).map(function(ident) {
				return ident.value;
			}).join(" ")) {
		...
		var asString = function(color) {
			var alpha = 255 & color;
			var blue = 255 & color >> 8;
			var green = 255 & color >> 16;
			var red = 255 & color >> 24;
		...
		var processColorStops = function(stops, lineLength) {
			...
			for (var i = 0; i < processStops.length; i++) {
				...
				if (stop_2 === null) {
					...
					var gapValue = (stop_2 - processStops[gapBegin - 1]) / (gapLength + 1);
		...
		var lineBreak = {
			...
			parse: function(_context, lineBreak) {
				switch (lineBreak) {
					case "strict": return LINE_BREAK.STRICT;
					default: return LINE_BREAK.NORMAL;
				}
			}
		};
		var lineHeight = {
		...
		var wordBreak = {
			...
			parse: function(_context, wordBreak) {
				switch (wordBreak) {
					case "break-all": return WORD_BREAK.BREAK_ALL;
					case "keep-all": return WORD_BREAK.KEEP_ALL;
					default: return WORD_BREAK.NORMAL;
				}
			}
		};
		var zIndex = {
		...
		var ElementContainer = function() {
			function ElementContainer(context, element) {
				...
				if (isDebugging(element, 4)) this.flags |= 16;
			}
		...
		*/
		...
		var createCounterText = function(value, type, appendSuffix) {
			...
			switch (type) {
				...
				case 17:
				case 48: return createCJKCounter(value, "零一二三四五六七八九", CHINESE_INFORMAL_MULTIPLIERS, "負", cjkSuffix, CJK_TEN_COEFFICIENTS | CJK_TEN_HIGH_COEFFICIENTS | CJK_HUNDRED_COEFFICIENTS);
				case 47: return createCJKCounter(value, "零壹貳參肆伍陸柒捌玖", CHINESE_FORMAL_MULTIPLIERS, "負", cjkSuffix, CJK_ZEROS | CJK_TEN_COEFFICIENTS | CJK_TEN_HIGH_COEFFICIENTS | CJK_HUNDRED_COEFFICIENTS);
				case 42: return createCJKCounter(value, "零一二三四五六七八九", CHINESE_INFORMAL_MULTIPLIERS, "负", cjkSuffix, CJK_TEN_COEFFICIENTS | CJK_TEN_HIGH_COEFFICIENTS | CJK_HUNDRED_COEFFICIENTS);
				case 41: return createCJKCounter(value, "零壹贰叁肆伍陆柒捌玖", CHINESE_FORMAL_MULTIPLIERS, "负", cjkSuffix, CJK_ZEROS | CJK_TEN_COEFFICIENTS | CJK_TEN_HIGH_COEFFICIENTS | CJK_HUNDRED_COEFFICIENTS);
				case 26: return createCJKCounter(value, "〇一二三四五六七八九", "十百千万", JAPANESE_NEGATIVE, cjkSuffix, 0);
				case 25: return createCJKCounter(value, "零壱弐参四伍六七八九", "拾百千万", JAPANESE_NEGATIVE, cjkSuffix, CJK_ZEROS | CJK_TEN_COEFFICIENTS | CJK_TEN_HIGH_COEFFICIENTS);
				...
				case 32: return createCJKCounter(value, "零壹貳參四五六七八九", "拾百千", KOREAN_NEGATIVE, koreanSuffix, CJK_ZEROS | CJK_TEN_COEFFICIENTS | CJK_TEN_HIGH_COEFFICIENTS);
				...
				case 22: return createAdditiveCounter(value, 1, 10999, HEBREW, 3, defaultSuffix);
						...
						return __generator(this, function(_a) {
							switch (_a.label) {
								case 0:
									...
									if (typeof referenceElement === "undefined") return [2, Promise.reject("Error finding the " + this.referenceElement.nodeName + " in the cloned document")];
								...
								case 3:
									...
									_a.label = 4;
								case 4:
									if (typeof onclone === "function") return [2, Promise.resolve().then(function() {
					...
					return __generator(this, function(_a) {
						switch (_a.label) {
							case 0:
								...
								if (!isSameOrigin && this._options.allowTaint === false && !isInlineImage(key) && !isBlobImage(key) && !useProxy && !useCORS) return [2];
								src = key;
		...
		var getCurvePoints = function(x, y, r1, r2, position) {
			...
			var ym = y + r2;
			switch (position) {
				case CORNER.TOP_LEFT: return new BezierCurve(new Vector(x, ym), new Vector(x, ym - oy), new Vector(xm - ox, y), new Vector(xm, y));
				case CORNER.TOP_RIGHT: return new BezierCurve(new Vector(x, y), new Vector(x + ox, y), new Vector(xm, ym - oy), new Vector(xm, ym));
				case CORNER.BOTTOM_RIGHT: return new BezierCurve(new Vector(xm, y), new Vector(xm, y + oy), new Vector(x + ox, ym), new Vector(x, ym));
		...
		var parseStackTree = function(parent, stackingContext, realStackingContext, listItems) {
			parent.container.elements.forEach(function(child) {
				...
				if (contains(child.flags, 8)) processListItems(child, listOwnerItems);
			});
		};
		...
		var calculateBackgroundRendering = function(container, index, intrinsicSize) {
			...
			return [
				calculateBackgroundRepeatPath(getBackgroundValueForIndex(container.styles.backgroundRepeat, index), position, backgroundImageSize, backgroundPositioningArea, backgroundPaintingArea),
		...
		var calculateBackgroundSize = function(size, _a, bounds) {
			...
			if (isIdentToken(first) && (first.value === BACKGROUND_SIZE.CONTAIN || first.value === BACKGROUND_SIZE.COVER)) {
				if (hasIntrinsicValue(intrinsicProportion)) return bounds.width / bounds.height < intrinsicProportion !== (first.value === BACKGROUND_SIZE.COVER) ? [bounds.width, bounds.width / intrinsicProportion] : [bounds.height * intrinsicProportion, bounds.height];
		...
		var CanvasRenderer = function(_super) {
			...
			CanvasRenderer.prototype.renderNode = function(paint) {
				return __awaiter(this, void 0, void 0, function() {
					return __generator(this, function(_a) {
						switch (_a.label) {
							case 0:
								if (contains(paint.container.flags, 16)) debugger;
			...
			CanvasRenderer.prototype.renderTextWithLetterSpacing = function(text, letterSpacing, baseline) {
				...
				else segmentGraphemes(text.text).reduce(function(left, letter) {
			...
			CanvasRenderer.prototype.renderStackContent = function(stack) {
				return __awaiter(this, void 0, void 0, function() {
					...
					return __generator(this, function(_p) {
						switch (_p.label) {
							case 0:
								if (contains(stack.element.container.flags, 16)) debugger;
							...
							case 4:
								_i++;
								return [3, 2];
							case 5: return [4, this.renderNodeContent(stack.element)];
							case 6:
								_p.sent();
			...
			CanvasRenderer.prototype.resizeImage = function(image, width, height) {
				...
				var canvas = ((_a = this.canvas.ownerDocument) !== null && _a !== void 0 ? _a : document).createElement("canvas");
											...
											case 5:
												if (isLinearGradient(backgroundImage)) {
													...
													if (rx > 0 && ry > 0) {
														...
														if (rx !== ry) {
															midX = container.bounds.left + .5 * container.bounds.width;
															midY = container.bounds.top + .5 * container.bounds.height;
															f = ry / rx;
															invF = 1 / f;
															this_1.ctx.save();
					...
					return __generator(this, function(_a) {
						switch (_a.label) {
							...
							case 8:
								_a.sent();
								return [3, 11];
							case 9: return [4, this.renderSolidBorder(border.color, side, paint.curves)];
							case 10:
								_a.sent();
								_a.label = 11;
							case 11:
			...
			CanvasRenderer.prototype.renderDashedDottedBorder = function(color, width, side, curvePoints, style) {
				return __awaiter(this, void 0, void 0, function() {
					...
					return __generator(this, function(_a) {
						...
						this.ctx.beginPath();
						if (style === 3) this.formatPath(strokePaths);
		...
		var Logger = function() {
			...
			Logger.prototype.info = function() {
				...
				for (var _i = 0; _i < arguments.length; _i++) args[_i] = arguments[_i];
				if (this.enabled) {
					if (typeof window !== "undefined" && window.console && typeof console.info === "function") console.info.apply(console, __spreadArray([this.id, this.getTime() + "ms"], args));
				}
			};
		...
		var renderElement = function(element, opts) {
			return __awaiter(void 0, void 0, void 0, function() {
				...
				return __generator(this, function(_u) {
					switch (_u.label) {
						case 0:
							if (!element || typeof element !== "object") return [2, Promise.reject("Invalid element provided as first argument")];
							...
							if (!clonedElement) return [2, Promise.reject("Unable to find element in cloned iframe")];
...
//# sourceMappingURL=html2canvas-DgNdGxD_.js.map