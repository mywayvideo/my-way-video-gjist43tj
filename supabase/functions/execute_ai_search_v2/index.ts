...
function getHeuristicIntent(query: string, currentProductId: string | null): string {
  ...
  const institutionalPattern =
    /\b(horari|localiz|enderez|enderec|contat|garanti|logist|quem somos|onde fic|address|hours|location|sobre|about us|quienes somos|ubicacion|atendimento|aberto|fecha|opening hours|warranty|envio|frete|shipping|whatsapp|telefone|email|contact)\b/i
