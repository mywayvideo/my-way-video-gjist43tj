...
function getHeuristicIntent(query: string, currentProductId: string | null): string {
  ...
  const institutionalPattern =
    /\b(localiz|endereco|onde fica|address|ubicacion|horario|atendimento|aberto|fecha|opening hours|quem somos|sobre|about us|quienes somos|garantia|warranty|logistica|envio|frete|shipping|contato|whatsapp|telefone|email|contact)\b/i
