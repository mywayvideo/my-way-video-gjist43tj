      ...
      const res = await fetch(firecrawlUrl, {
        ...
        body: JSON.stringify({
          ...
          formats: [{
            ...
            prompt: "Extract the product name, sku, price in USD (only numbers), description, technical specifications (as markdown), weight, dimensions, main image URL, category, whether it is discontinued, and stock availability."
          }],
