...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    return new Response(JSON.stringify({ error: 'Não foi possível criar cliente.', details: err.message }), { status: 500, headers: { ...corsHeaders, 'Content-Type': 'application/json' } })
  }
})
