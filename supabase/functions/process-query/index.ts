...
${hasIntelData || isNABQuery ? '- É EXPRESSAMENTE PROIBIDO dizer que "não há informações" se houver correspondência em \'title\' ou \'ai_summary\'. Utilize os dados reais da inteligência fornecida.' : ''}
