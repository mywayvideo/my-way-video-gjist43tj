...
- Regras Logísticas: ${logisticsRulesPrompt}
${hasIntelData ? '- É EXPRESSAMENTE PROIBIDO dizer que "não há informações". Utilize os dados reais da inteligência fornecida.' : ''}
${isNABQuery || hasIntelData ? '- Inicie sua resposta com: "Confirmamos diretamente da NAB 2026: "' : ''}
`
