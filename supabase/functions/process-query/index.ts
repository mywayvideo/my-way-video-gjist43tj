...
Deno.serve(async (req: Request) => {
  ...
  try {
    const { query, products = [], intelligence = [], agentId, isNABQuery, assembledPrompt, temperature = 0.2 } = await req.json()
...
- SEMPRE inclua o aviso de garantia integral no Brasil e América Latina.
