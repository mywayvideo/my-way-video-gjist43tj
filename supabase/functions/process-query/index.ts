...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    const logisticsRulesPrompt = (aiSettings?.logistics_rules_prompt || "") + 
      '\nIMPORTANTE: Se o produto não tiver preço cadastrado (0 ou nulo) tanto em USD quanto Nacionalizado, a disponibilidade é "Sob Consulta" e NUNCA presuma que é estoque nacional ou Brasil.'
