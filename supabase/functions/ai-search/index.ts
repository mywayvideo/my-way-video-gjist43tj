...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    // Explicitly include technical_info and image_url in the query
    const { data: allProducts } = await supabase.from('products').select(`id, name, sku, description, price_usd, technical_info, image_url`)
