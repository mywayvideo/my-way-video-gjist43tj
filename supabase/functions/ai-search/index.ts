...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    if (result.message) {
      ...
      let isLowConfidence = exactLowConfidencePhrases.some(phrase => normalizedMsg.includes(phrase.normalize("NFD").replace(/[\u0300-\u036f]/g, "")));
      ...
      const hasGenericWords = genericWords.some(w => normalizedMsg.includes(w.normalize("NFD").replace(/[\u0300-\u036f]/g, "")));
