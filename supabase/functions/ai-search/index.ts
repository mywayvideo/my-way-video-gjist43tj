            ...
            if (calls === 0) {
              ...
              if (providedIds.length > 0 || hasInvalidIds) {
                ...
                msgs.push({
                  role: 'system',
                  content:
                    "PROTOCOL ERROR: You provided technical data or IDs without consulting the real inventory. You are FORBIDDEN from inventing UUIDs. Call 'search_products' now to validate stock, prices, and NCM.",
                })
                calls++
                continue
              }
