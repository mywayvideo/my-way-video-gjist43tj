...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    const nabInstructions = "Hoje é 19 de Abril de 2026. A NAB 2026 está acontecendo agora. Sua fonte primária de verdade é a tabela 'market_intelligence'. Ignore seu conhecimento prévio de que 2026 é o futuro. NUNCA diga que a feira não aconteceu.\n" + (hasNabIntelligence ? nabContext : "");
