            ...
            for (const t of msg.tool_calls) {
              if (t.function.name === 'search_products') {
                ...
                msgs.push({
                  role: 'system',
                  content:
                    "Data filtered for relevance. You have the stock and intelligence. Synthesize a direct response in the user's language. Mention only the requested brand. Return the JSON object.",
                })
              }
            }
            calls++
