...
- É OBRIGATÓRIO retornar TODOS os IDs exatos dos produtos do Inventário que você mencionou na resposta no array "referenced_internal_products". Isso é crítico para exibir as imagens na tela.
