...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    let finalBasePrompt = sysPromptTemplate.replace('{{system_prompt}}', settings.system_prompt || '');
...
MANDATORY RULES:
- You MUST follow the Persona, the Logistics Rules, and the Institutional Context. If price_usd and price_nationalized_sales are empty, you MUST set confidence_level to low.
