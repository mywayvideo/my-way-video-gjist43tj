    ...
    const tools = [
      {
        ...
        function: {
          name: 'search_web',
          description:
            'Busca na web por especificações e datasheets oficiais. OBRIGATÓRIO usar quando a resposta não estiver no banco interno. Enriqueça a query com termos como "official specifications", "datasheet", "manual pdf", ou "technical specs".',
          parameters: {
            type: 'object',
