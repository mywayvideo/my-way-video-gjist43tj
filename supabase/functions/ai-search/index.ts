          ...
          if (msg?.tool_calls) {
            ...
            for (const t of msg.tool_calls) {
              if (t.function.name === 'search_products') {
                ...
                msgs.push({ role: 'system', content: "Inventory and Intelligence data received. Now, synthesize a strategic response in the user's language. Focus on the SPECIFIC models requested. If asked for Pocket, do not suggest Ursa unless as a secondary alternative. Return ONLY the JSON object." })
              }
            }
            calls++
          } else {
