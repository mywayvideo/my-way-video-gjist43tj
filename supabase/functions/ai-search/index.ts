...
- Se fornecer estimativas em BRL, avise explicitamente que o valor final dependerá de cálculo dinâmico cambial e tributário.`
    ...
    const tools = [{ 
      ...
      function: { 
        name: 'search_web', 
        description: 'Busca na web por especificações e datasheets oficiais. OBRIGATÓRIO usar quando a resposta não estiver no banco interno. Enriqueça a query com termos como "official specs", "datasheet", ou "manual".', 
