...
Deno.serve(async (req: Request) => {
  ...
  const fallbackResponse = {
    message:
      'Neste momento não consigo acessar uma resposta precisa sobre esta especificação. Sugiro contatar um de nossos especialistas para obter a solução audiovisual correta.',
    ...
    const tools = [
      {
        ...
        function: {
          name: 'search_web',
          description: 'Busca na web por especificações e datasheets oficiais',
          parameters: {
            type: 'object',
