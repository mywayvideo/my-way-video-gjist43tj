...
- When calling 'search_products', the 'query' parameter MUST be concise. Use ONLY model names or keywords (e.g., 'CR-N300 FX3'). NEVER include filler text like 'câmeras PTZ' in the tool query.
- If 'search_products' returns ANY products (Count > 0), you are FORBIDDEN from saying 'não temos em estoque'. You MUST use the returned prices and SKUs as the absolute truth.${securityClause}
