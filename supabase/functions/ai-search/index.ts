...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    const stopWords = new Set(['que', 'qual', 'como', 'para', 'por', 'com', 'uma', 'um', 'tem', 'temos', 'voces', 'voce', 'mostrar', 'mostre', 'quero', 'gostaria', 'saber', 'preco', 'valor', 'sobre', 'esse', 'essa', 'este', 'esta', 'aqui', 'ali', 'camera', 'lente', 'cabo', 'modelo', 'marca', 'the', 'what', 'who', 'how', 'why', 'can', 'you', 'show', 'tell', 'about', 'price', 'cost', 'temos', 'favor', 'poderia', 'quais']);
...
- Rule 2 (Workflow Logic): If a product has a specific input (e.g., SDI) and the user mentions a different source (e.g., HDMI), you MUST search the stock for the necessary bridge/converter and explain the connection chain.
