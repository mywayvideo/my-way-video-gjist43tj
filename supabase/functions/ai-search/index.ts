...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    if (intelligence && intelligence.length > 0) {
      ...
      nabContext =
        'DADOS OFICIAIS DA FEIRA (FONTE INTERNA):\n' +
        intelligence
    ...
    const nabInstructions = hasNabIntelligence
      ? 'HOJE É 19 DE ABRIL DE 2026. A NAB 2026 ESTÁ ACONTECENDO AGORA. Sua fonte primária de verdade são os DADOS OFICIAIS DA FEIRA. Ignore seu conhecimento prévio de que 2026 é o futuro. NUNCA diga que a feira não aconteceu.\n' +
        nabContext
      : ''
