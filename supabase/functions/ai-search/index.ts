...
${hasNabIntelligence ? '- É EXPRESSAMENTE PROIBIDO dizer que "não há informações". Baseie-se nos dados reais da inteligência fornecida.' : ''}
${hasNabIntelligence ? '- Inicie sua resposta com: "Confirmamos diretamente da NAB 2026: "' : ''}
