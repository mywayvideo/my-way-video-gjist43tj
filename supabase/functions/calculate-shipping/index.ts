...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    if (delivery_type === 'coleta') {
      ...
      if (!matchedRange) {
        throw new Error("Distancia alem do perimetro maximo de Miami. Selecione 'Entrega EUA' para usar UPS.");
      }
    ...
    const isValidation = msg.includes("Nao foi possivel validar") || 
